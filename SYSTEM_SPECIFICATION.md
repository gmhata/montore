...
- 会話ログの事実に基づく具体的な観察を少なくとも3点含める
  （例:「氏名確認なし」「OLDCARTの"増悪/緩和因子"未確認」「胸痛の随伴症状を未質問」等）
...
| 点数 | 基準 |
|------|------|
| 2点 | OLDCART（発症時期・部位・持続時間・性状・増悪/緩和因子・放散・時間/治療）のうち5項目以上を聴取 |
| 1点 | OLDCARTのうち2〜4項目を聴取 |
| 0点 | OLDCART項目の聴取が1項目以下 |
...
- **D**uration: 持続時間
- **C**haracter: 性状
- **A**ggravating/Alleviating: 増悪/緩和因子
- **R**adiation: 放散
- **T**iming/Treatment: 時間/治療
